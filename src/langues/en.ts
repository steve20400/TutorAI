...
modeleEssai: "Served to those trying without an account",
    ...
    signalements: {
      etiquette: "Alerts",
      titreCalme: "No report waiting.",
      titreAttend: { one: "One report is waiting to be read.", other: "{n} reports are waiting to be read." },
      intro: "A parent raising a concern about a session, or the platform itself when an adult is refused ten times. Each report is closed with a reason.",
      aucunTitre: "No reports.",
      aucunDetail: "That is the good news. They will appear here as soon as a parent raises a concern, or a behaviour triggers an automatic alert.",
      filtreNonLues: "Unread",
      filtreLues: "Read",
      filtreToutes: "All",
      marquerLue: "I have read it",
      lueLe: "Read on {date}",
      par: "Reported by {nom}",
      parLaPlateforme: "Reported by the platform",
      vise: "About {nom}",
      lu: "Read",
      nouveau: "Waiting",
      traite: "Closed",
      classer: "Close",
      decision: "Decision",
      decisionAide: "Why you are closing it this way. Someone may read it again in six months.",
      decisionExemple: "Checked with the parent — misunderstanding, no further action.",
      decisionObligatoire: "Write why you are closing this report.",
      classe: "Report closed.",
      echec: "Closing failed.",
    },
    programmes: {
