...
export const en: Dictionnaire = {
  ...
  recuperation: {
    ...
    titre: "Find your account",
    sousTitre: "We will send you a link to choose a new password.",
    phare: "It happens.",
    email: "Your address",
    envoyer: "Send the link",
    envoye: "If an account exists with this address, the link has just been sent. It works only once and expires after ten minutes. Check your spam folder too.",
    adresseAttendue: "Write your email address.",
    ...
    enfantEnvoye: "If an adult is linked to your account, they have just been told — by email and in their space. Ask them to help you: the request lasts ten minutes.",
    ...
    pageTitre: "Children's passwords",
    pageDetail: "When one of your children forgets their password, their request arrives here — and by email. It lasts ten minutes, and works only once.",
    pageAucune: "No request at the moment. If your child forgot their password, tell them to click “Forgot your password?” on the sign-in screen.",
    carteFermee: "This request is closed: the ten minutes have passed, or the password has already been changed. Send a new one if needed.",
    lienDepuisAccueil: "A password request is waiting for you",
    ...
    enfantDetail: "If an adult is linked to your account, ask them for help. Otherwise nobody can recover your password — you will need a new account.",
    nouveauTitre: "Choose a new password",
...
modeleEssai: "Served to those trying without an account",
    ...
    actionsDuRegistre: {
      verification: "checked the file of",
      activation: "changed a module",
      activation_refusee_cle_manquante: "tried to switch on a module without its key",
      reglage: "changed a setting",
      signalement: "raised a report",
      signalement_lu: "read a report",
      signalement_traite: "closed a report",
      desactivation: "deactivated the account of",
      reactivation: "reactivated the account of",
      programme_saisi: "filled in the syllabus",
      mot_de_passe_enfant_reinitialise: "gave a new password to",
      parLaPlateforme: "The platform",
      cibleAnonyme: "an account",
    },
    registre: {
