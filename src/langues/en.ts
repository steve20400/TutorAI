...
export const en: Dictionnaire = {
  ...
  recuperation: {
    ...
    envoye: "If an account exists with this address, the link has just been sent. It works only once, and it expires. Check your spam folder too.",
    ...
    pageDetail: "When one of your children forgets their password, their request arrives here — and by email. It works only once, and its expiry time is written on the card.",
    ...
    carteFermee: "This request is closed: the delay has passed, or the password has already been changed. Send a new one if needed.",
