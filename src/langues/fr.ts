...
export const fr = {
  ...
  recuperation: {
    ...
    envoye: "Si un compte existe avec cette adresse, le lien vient de partir. Il ne sert qu'une fois et expire au bout de dix minutes. Regardez aussi dans vos indésirables.",
    ...
    enfantEnvoye: "Si un adulte est rattaché à ton compte, il vient d'être prévenu — par mail et dans son espace. Demande-lui de t'aider : la demande vaut dix minutes.",
    ...
    pageDetail: "Quand un de vos enfants oublie son mot de passe, sa demande arrive ici — et par courriel. Elle vaut dix minutes, et ne sert qu'une fois.",
    ...
    carteFermee: "Cette demande est close : les dix minutes ont passé, ou le mot de passe a déjà été changé. Renvoyez-en une nouvelle si besoin.",
